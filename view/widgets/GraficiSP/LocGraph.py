...
class LocGraph():
    ...
    def __init__(self,master, process_dict):
        ...
        self.ax_loc.plot(y, x1, label='Linee di Codice', marker='o')
        self.ax_loc.plot(y, x2, label='Linee vuote', marker='o')
        self.ax_loc.plot(y, x3, label='Commenti', marker='o')
        self.ax_loc.legend()
        self.ax_loc.set_title("Amount (in LOC) of previous changes")
        self.ax_loc.set_xticklabels(y, rotation=45, ha='right')
...
class RevisionGraph():
    ...
    def __init__(self, master, process_dict):
        ...
        self.ax_revision.bar(y, x)
        self.ax_revision.legend()
        self.ax_revision.set_title("Number of revisions")
        self.ax_revision.set_xticklabels(y, rotation=45, ha='right')
...
class BugFixGraph():
    ...
    def __init__(self, master, process_dict):
        ...
        self.ax_bugfix = fig_bugfix.add_subplot(111)
        x, y = co.bugfix(process_dict)
        self.ax_bugfix.bar(y, x)
        self.ax_bugfix.legend()
        self.ax_bugfix.set_title("Number of bugfix commits")
        self.ax_bugfix.set_xticklabels(y, rotation=45, ha='right')

        self.canvas_bugfix = FigureCanvasTkAgg(fig_bugfix, master=master)
...
class ChurnGraph():
    ...
    def __init__(self, master, process_dict):
        ...
        self.ax_codechurn = fig_codechurn.add_subplot(111)
        x, y = co.codeC(process_dict)
        self.ax_codechurn.bar(y, x)
        self.ax_codechurn.legend()
        self.ax_codechurn.set_title("Number of code churn commits")
        self.ax_codechurn.set_xticklabels(y, rotation=45, ha='right')

        self.canvas_codechurn = FigureCanvasTkAgg(fig_codechurn, master=master)
...
class WeeksGraph():
    ...
    def __init__(self, master, process_dict):
        ...
        self.ax_weeks = fig_weeks.add_subplot(111)
        x, y = co.weeks(process_dict)
        self.ax_weeks.bar(y, x)
        self.ax_weeks.legend()
        self.ax_weeks.set_title("Number of weeks")
        self.ax_weeks.set_xticklabels(y, rotation=45, ha='right')

        self.canvas_weeks = FigureCanvasTkAgg(fig_weeks, master=master)
...
class AuthorsGraph():
    ...
    def __init__(self, master, process_dict):
        ...
        self.ax_authors = fig_authors.add_subplot(111)
        x, y = co.authors(process_dict)
        self.ax_authors.bar(y, x)
        self.ax_authors.legend()
        self.ax_authors.set_title("Number of authors")
        self.ax_authors.set_xticklabels(y, rotation=45, ha='right')

        self.canvas_authors = FigureCanvasTkAgg(fig_authors, master=master)
